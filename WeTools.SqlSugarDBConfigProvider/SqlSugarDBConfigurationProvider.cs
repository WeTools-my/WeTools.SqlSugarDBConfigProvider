...
{
    public class SqlSugarDBConfigurationProvider : ConfigurationProvider, IDisposable
    {
        ...
        private readonly ISqlSugarDBConfigService _appConfig;

        public SqlSugarDBConfigurationProvider(SqlSugarDBConfigOption option)
        {
            _option = option;

            _appConfig = new SqlSugarDBConfigService(option);
        ...
        public SqlSugarDBConfigurationProvider(SqlSugarDBConfigOption option, ISqlSugarDBConfigService serverAppConfig)
        {
            _option = option;

            _appConfig = serverAppConfig;
